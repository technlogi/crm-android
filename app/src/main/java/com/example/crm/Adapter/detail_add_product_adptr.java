...
public class detail_add_product_adptr  extends RecyclerView.Adapter<detail_add_product_adptr.ViewHolder> {

    List<visit_detail_POJO.Product> detail_add_productlist;
    Context context;

    public detail_add_product_adptr(List<visit_detail_POJO.Product> detail_add_productlist, Context context) {
    ...
    @NonNull
    @Override
    public detail_add_product_adptr.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull detail_add_product_adptr.ViewHolder holder, int position) {
